...
import Page1 from "./Streaming-page1";
import Page2 from "./Streaming-page2";
...
const Design = () => {
  ...
  const goreport = () => {
    window.location.replace("/report-streaming");
  }
    ...
    <div>
      <div className="bgstreaming">
        <div className="aboutfont">
          <b>ประเภทเว็บไซต์ Streaming</b>
        </div>
      </div>

      <div className="center font mymt50">
        <b className="font24">ประเภทเว็บไซต์ Streaming</b>
