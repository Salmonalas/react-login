...
const Report = () => {
  ...
  const loaddata = async (id) => {
    axios.post("/reports-social", { id: id }).then((res) => {
      try {
  ...
  return (
    <>
      ...
      <Grid centered>
        <h1 className="font"><b>ประเภทเว็บไซต์ Social Media</b></h1>
        <Grid.Row>
          <h5 className="font">
      ...
      <Segment className="mymt100">
        <Grid columns={2} textAlign="center" centered >
          {/* <Divider vertical>Or</Divider> */}
          <Grid.Column>
            <Image className="mymt" centered size="huge" src={img} />
          </Grid.Column>
